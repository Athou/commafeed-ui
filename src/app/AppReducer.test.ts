...
describe("Tree reducer", () => {
    ...
    it("changes category expanded status", () => {
        ...
        const state = reducer(initialState, { type: "tree.setCategoryExpanded", categoryId: 1000, expanded: true })
    ...
    it("decrements feed unread count", () => {
        ...
        const state = reducer(initialState, { type: "entries.setRead", id: "29002", feedId: 1002, read: true })
...
describe("Entries reducer", () => {
    it("changes source", () => {
        ...
        const state = reducer(initialState, { type: "entries.setSource", id, source })
    ...
    it("changes entries", () => {
        ...
        const state = reducer(initialState, { type: "entries.setEntries", entries, hasMore, label })
    ...
    it("selects entry", () => {
        ...
        const state = reducer(initialState, { type: "entries.setSelectedEntryId", id })
    ...
    it("expands selected entry", () => {
        ...
        const state = reducer(initialState, { type: "entries.setSelectedEntryExpanded", expanded })
    ...
    it("marks as read", () => {
        ...
        const state = reducer(initialState, { type: "entries.setRead", id: "29002", feedId: 0, read })
    ...
    it("sets loading status", () => {
        ...
        const state = reducer(initialState, { type: "entries.setLoading", loading })
...
describe("Settings reducer", () => {
    ...
    it("changes reading mode", () => {
        ...
        const state = reducer(initialState, { type: "settings.setReadingMode", readingMode })
    ...
    it("changes reading order", () => {
        ...
        const state = reducer(initialState, { type: "settings.setReadingOrder", readingOrder })
...
describe("Redirect reducer", () => {
    ...
    it("redirects to category", () => {
        expect(initialState.redirect.redirectTo).toBeUndefined()
        const state = reducer(initialState, { type: "navigateToCategory", categoryId: "12" })
        expect(state.redirect.redirectTo).toBe(Routes.app.category.create({ categoryId: "12" }))
    })
    it("redirects to feed", () => {
        expect(initialState.redirect.redirectTo).toBeUndefined()
        const state = reducer(initialState, { type: "navigateToFeed", feedId: 12 })
        expect(state.redirect.redirectTo).toBe(Routes.app.feed.create({ feedId: "12" }))
    })
})
